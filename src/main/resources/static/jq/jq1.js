...
function categoryChange(e) {
    let up_category2_a = ["자켓","상의","코트","집업/점퍼","패딩"];
    let up_category2_b = ["청바지","슬랙스","면바지","짧은바지"];
    let up_category2_c = ["원피스", "스커트", "치마바지"];
    let up_category2_d = ["니트","가디건","조끼"];
    let up_category2_e = ["신발","가방","머플러/스카프","모자","주얼리","기타"];
    let up_category2_f = ["레깅스/스타킹","양말","이너웨어"];


    let target = document.getElementById("up_category2");

    if(e.value == "1") var d = up_category2_a;
    else if(e.value == "2") var d = up_category2_b;
    else if(e.value == "3") var d = up_category2_c;
    else if(e.value == "4") var d = up_category2_d;
    else if(e.value == "5") var d = up_category2_e;
    else if(e.value == "6") var d = up_category2_f;
