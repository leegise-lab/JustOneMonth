...
<head>
    ...
    <title>간편 회원가입</title>
    <link rel="stylesheet" href="./css/regist.css?ver=1">
...
<div id="contentWrapper">
    <div id="contentWrap">
        <div1 id="content" style="width: 100%">

            <div id="join_test">
                <h2 class="tit-page">간편회원가입</h2>
                <div class="page-body">
                    <form name="join-form" id="join-form" method="post" action="/login" onsubmit="return sendit()">
                        <div class="box-wrap">
                            <ul class="join-form">
                                <li><label>이름
                                    <input type="text" name="name" id="name"
                                           class="MS_input_txt w137 txt-input input-label" size="15" maxlength="30"/>
                                </label>
                                </li>
                                <li><label>아이디
                                    <input type="text" name="id" id="id"
                                           class="MS_input_txt w137 txt-input input-label" size="10" maxlength="12"/>
                                </label>
                                </li>
                                <li><label>성별
                                    <input placeholder="여자/남자 입력하시오." type="text" name="gender" id="gender"
                                           class="MS_input_txt MS_input_txt06 w137 txt-input input-label" size="20"
                                           maxlength="35" onchange="this.form.emailcheck.value=''"/></label>
                                </li>
                                <li><label>비밀번호
                                    <input type="password" name="password1" id="password1"
                                           class="MS_input_txt w137 txt-input input-label" size="15"
                                           maxlength="20" onkeyup="check_pwd_length(this, 'password');"/></label></li>
                                <li><label>비밀번호 확인
                                    <input type="password" name="password2" id="password2"
                                           class="MS_input_txt w137 txt-input input-label" size="15"
                                           maxlength="20" onkeyup="check_pwd_length(this, 'repassword');"/>
                                </label></li>
                                <li><label>이메일
                                    <input type="email" name="email" id="email"
                                           class="MS_input_txt MS_input_txt06 w137 txt-input input-label" size="20"
                                           maxlength="35" id="email" value="" onchange="this.form.emailcheck.value=''"/>
                                </label>
                                </li>
                                <li><label>생년월일(ex.20001010)
                                    <input type="text" name="birth" id="birth"
                                           class="MS_input_birth MS_input_txt06 w137 txt-input input-label" value=""
                                           size="15" maxlength="8"/></label></li>
                                <li><label>휴대폰번호
                                    <input type="tel" name="hp" id="hp"
                                           class="MS_input_tel w137 txt-input input-label" size="15" maxlength="30"
                                    /></label></li>
                                <li><label>
                                    <input type="text" name="zipcode" placeholder="우편번호 (클릭해주세요)" id="sample6_postcode" onclick="sample6_execDaumPostcode()"
                                           class="MS_input_tel w137 txt-input input-label" size="15" maxlength="30"
                                    /></label></li>
                                <li><label>
                                    <input type="text" name="address1"placeholder="주소" id="sample6_address"
                                           class="MS_input_tel w137 txt-input input-label" size="15" maxlength="30"
                                    /></label></li>
                                <li><label>상세 주소
                                    <input type="text" name="address2" id="sample6_detailAddress"
                                           class="MS_input_tel w137 txt-input input-label" size="15" maxlength="30"
                                    /></label></li>
                                <input name="address3" type="hidden" id="sample6_extraAddress">
                            </ul>
                            <ul class="join-msg">
                                <li style="padding-bottom:5px;color:#111;"><label><input type="checkbox"
                                                                                         name="user_age_check"
                                                                                         value="Y"> 14세 이상입니다.
                                    (필수)</label></li>
                            ...
                            <fieldset>
                                ...
                                <div class="new-privercy-contract">
                                    <div id="chkwrap">
                                        <div class="all-chk">
                                            <label><input type="checkbox" name="every_agree" id="every_agree"
                                                          value="all" class="input-cbox new_every_agree"/> 전체동의</label>
                                            <input type="hidden" name="allnew_agree" id="allnew_agree" value="Y"></div>
                                        <div class="cont p10">
                                            <ul>
                                                ...
                                                <li class="ml-30 pt-10">
                                                    <label><input type="checkbox" name="privacy1" id="privacy1"
                                                                  value="agree_uidB" class="input-cbox every_agree"/>
                                                        개인정보 수집 및 이용 안내</label> <a href="#chk_cont2">내용보기</a></li>
                                                <li class="ml-30 pt-10"><label><input type="checkbox" name="privacy3"
                                                                                      id="privacy3" value="agree_uidD"
                                                                                      class="input-cbox every_agree"/>
                                                    개인정보 처리위탁</label><a href="#chk_cont4">내용보기</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="btn-area">
                                        <input type="submit" class="CSSbuttonBlackB"></a>
                                        <a href="Javascript:history.back()" class="CSSbuttonGray">취소</a>
                                    </div>
                                    <div class="privercyArea">
                                        <div class="appendPrivercy" id="chk_cont1_cont"></div>
                                        <div class="appendPrivercy" id="chk_cont2_cont"></div>
                                        <div class="appendPrivercy" id="chk_cont4_cont"></div>
                                        <div class="privercy-contract">
                                            <h4 class="tit" id="chk_cont1">이용약관</h4>
                                            <textarea cols="80" wrap="off" rows="10" readonly>인터넷 쇼핑몰 『 주식회사 제이오진 사이버 몰』회원 약관

제1조(목적)
이 약관은 주식회사 제이오진 회사(전자상거래 사업자)가 운영하는 주식회사 제이오진 사이버 몰(이하 "몰"이라 한다)에서 제공
...
제2조(정의)
①"몰" 이란 주식회사 제이오진 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴
...
번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 주식회사 제이오진 사이버몰의 초기 서비스화면(전면)
...
#카카오 알림톡 시행에 관한 내용
신규 회원의 전화번호 수집 양식 및 기존 회원 대상의 공지 이메일 등을 통해 안내 주문, 배송 정보 등 비광고성 정보를 카카오톡 알림톡으로 알려드리며, 만약 알림톡 수신이 불가능하거나 수신 차단하신 경우에는 일반 문자 메시지로 보내드립니다. 와이파이 아닌 이동통신망으로 접속시 알림톡 수신 중 데이터요금이 발생할 수 있습니다. 알림톡과는 다른 방식으로 정보 수신을 원하시면 알림톡을 차단해주세요.

# 카카오톡 상담톡 시행에 관한 내용
상담업무를 카카오톡 상담톡으로 진행하며, 만약 카카오톡을 통해 안내되는 상담 내용을 Wi-Fi 나 PC가 아닌 이동통신망으로 이용할 경우, 데이터 요금이 발생할 수 있습니다. 카카오톡을 통해 상담을 원치 않으실 경우 고객센터, 게시판 문의를 이용해 주시기 바랍니다.
...
단, 적립금의 경우 회사는 별도의 공지없이 적립금의 이용가능범위를 제한할 수 있습니다.
2. 예치금은 회원에 한하여 제공되는 서비스이며 신용카드,모바일, 현금을 이용하여 지불할 수 있습니다.
3. 적립금은 회원에 한하여 제공되는 서비스입니다.
4. 적립금은 구매금액의 최대 20%만 사용이 가능합니다.
5. 적립금과 예치금은 타 결제수단(신용카드,모바일,현금)과 함께 사용될 수 있습니다.
7. 회사는 각종 할인이벤트 또는 제휴이벤트 등의 특정기간에는 적립금 또는 예치금의 신청 및 이용을 제한할 수 있습니다.
8. 회원이 상품구매나 이벤트 등을 통하여 회사로부터 무상 제공받은 적립금의 경우 회사에서 정한 기한에 한해서만 이용 가능합니다.
9. 유효기간 : 회사로부터 제공받은 적립금의 경우 유효기간은 적립금이 제공된 날을 기준으로 익년 12월 31일까지입니다.
유효기간이 경과한 적립금은 자동적으로 소멸하게 됩니다.
10. 9번 항목의 유효기간에도 불구하고 아래 회원의 경우 "몰"은 7번 항목의 유효기관과 상관없이 해당 회원의 적립된 적립금을 회수할 수 있습니다.
- 최종누적 일로부터 1년간 추가누적이 없거나 적립금 소멸일 기준으로 최근 1년간 로그인한 이력이 없는 회원
본 약관은 2007년12월10일부터 적용됩니다.
</textarea>
                                        </div>
                                        ...
                                        <table border="0" summary="구분, 목적, 항목, 보유기간, 필수정보, 선택정보" class="contract-tbl">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="p10 itemsY">이름, 아이디, 비밀번호, 이메일, 휴대폰, 생일</div>
                                                </td>
                                                <td>
                                                    <div class="p10 holdingY">회원탈퇴 후 5일까지</div>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table border="0" summary="구분, 목적, 항목, 보유기간, 필수정보, 선택정보" class="contract-tbl">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="p10 holding1">회원탈퇴 후 5일까지</div>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                        <h4 class="tit" id="chk_cont4">개인정보 처리위탁 (선택)</h4>
                                        <input type="hidden" name="agree_uidD" id="agree_uidD" value="6_9_">
                                        <table border="0" summary="수탁자, 목적" class="contract-tbl">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="p10 trustee6">(주)루나소프트</div>
                                                </td>
                                                <td>
                                                    <div class="p10 purpose6">카카오톡 알림톡 발송 및 톡 기반 상담 서비스 제공</div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <div class="p10 trustee9">(주)크리마팩토리</div>
                                                </td>
                                                <td>
                                                    <div class="p10 purpose9">주문관련정보,간편리뷰작성/관리 및 장바구니 알림</div>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
