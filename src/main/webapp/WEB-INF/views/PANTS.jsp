...
<main>
        ...
        <ul id="Shortcuts">
            ...
            <li class="Shortcuts_btn " value="1">청바지</li>
            <li class="Shortcuts_btn " value="2">슬랙스</li>
            <li class="Shortcuts_btn " value="3">면바지</li>
            <li class="Shortcuts_btn " value="4">짧은 바지</li>
        </ul>
