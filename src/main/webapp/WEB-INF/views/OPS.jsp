...
<body>
    <main>
        ...
        <ul id="Shortcuts">
            ...
            <li class="Shortcuts_btn " value="1">원피스</li>
            <li class="Shortcuts_btn " value="2">스커트</li>
            <li class="Shortcuts_btn " value="3">치마바지</li>
        ...
        <div class="bestbox_top20 displaynone1">
            <c:forEach var="item" items="${list1}"  end="${list1.size()/4}">
                <div class="bestbox_line">
                    <% for (int i = 0; i <4;i++){%>
                    <c:forEach var="item" items="${list1}" begin="<%=j%>" end="<%=j%>">
                        <div class="bestbox_list">
                            <a href="item?up_idx=${item.up_idx}"><img src="./images/in/${item.up_file1}" alt=""></a>
                            <ul class="explan">
                                <li><p class="tem_name">${item.up_name}</p></li>
